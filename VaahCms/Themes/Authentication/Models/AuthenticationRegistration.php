<?php namespace VaahCms\Themes\Authentication\Models;

use Illuminate\Http\Request;
use Illuminate\Support\Facades\Crypt;
use Illuminate\Support\Str;
use VaahCms\Themes\Authentication\Notifications\ActivationLinkNotification;
use WebReinvent\VaahCms\Entities\Registration;
use WebReinvent\VaahCms\Entities\User;

class AuthenticationRegistration extends Registration
{
	...
	public static function activateRegistration($request)
    {
        ...
        // Create User
        $user = AuthenticationUser::createUser($user_request);
        ...
        $response['status'] = 'success';
        $response['data']['redirect_url'] = route('vh.frontend.authentication.signin');
