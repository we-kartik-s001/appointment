<?php  namespace VaahCms\Themes\Authentication\Notifications;
...
class ActivationLinkNotification extends Notification {
     ...
     * @return void
     */
    public function __construct(AuthenticationRegistration $registration)
    {
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->action(
                'Activate',
                route(
                    'vh.frontend.authentication.signup.activate',
