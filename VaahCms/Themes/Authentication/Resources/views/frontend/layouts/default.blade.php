...
<html lang="en">
    <head>
        ...
        @if(env('THEME_AUTHENTICATION_ENV') == 'develop')
            <link href="http://localhost:8080/authentication/assets/css/build.css"
                  rel="stylesheet" media="screen">
            <link href="http://localhost:8080/authentication/assets/css/style.css"
                  rel="stylesheet" media="screen">
        @else
            <link  href="{{vh_theme_assets_url("Authentication", "css/build.css")}}"
                   rel="stylesheet" media="screen">
            <link  href="{{vh_theme_assets_url("Authentication", "css/style.css")}}"
                rel="stylesheet" media="screen">
        @endif
        -->
	...
	<body>
        ...
        <script src="{{vh_theme_assets_url("Authentication", "build/script.js")}}"></script>
